...
namespace GameBasicClasses.BasicClasses
{
    public class GameFactory
    {
        ...
        public static GameModel fourPlayerGame()
        {
            ...
            gm.addBall(new Ball(1f, 50, Color.Empty, GameBasicClasses.Properties.Resources.fact_core_avatar_by_the_rebexorcist_d3h18dn, 1460, 911));
            Paddle p = new Paddle(true, Color.Empty, GameBasicClasses.Properties.Resources.batred, 1, 14, 60, 10, true, 1460, 911);
            Paddle p2 = new Paddle(false, Color.Empty, GameBasicClasses.Properties.Resources.batblue, 1, 14, 60, 10, false, 1460, 911);
            Paddle p3 = new Paddle(true, Color.Empty, GameBasicClasses.Properties.Resources.batred, 2, 14, 60, 10, true, 1460, 911);
            Paddle p4 = new Paddle(false, Color.Empty, GameBasicClasses.Properties.Resources.batblue, 2, 14, 60, 10, false, 1460, 911);
            gm.addGamer(new Human(Keys.Up, Keys.Down, p2));
            gm.addGamer(new Human(Keys.Z, Keys.S, p));
            gm.addGamer(new Human(Keys.T, Keys.G, p4));
            gm.addGamer(new Human(Keys.I, Keys.K, p3));
            return gm;
        }
    }
}
